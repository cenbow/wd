...
public class HttpRequestHelper {
    ...
    public static  String doGetMethod2(String url,Map<String, String> keyValueMap,Log logger) throws MalformedURLException {   
       ...
       /* URL strUrl = new URL(url); 
        String host = strUrl.getHost(); 
        int port = strUrl.getPort(); 
      
        Protocol myhttps = new Protocol("http", new MySecureProtocolSocketFactory (), port); 
	...
	public static String PostOrdinaryPush(String url,Map<String, String> keyValueMap) {
		//String url = "http://"+ JiveGlobals.getXMLProperty("push.host") + "/push-service/api/v1/message/toalias";
		try {
			/*String message = URLEncoder.encode("{\"title\":\"" + Name + "\",\"senderName\":\"" + Name + "\",\"senderId\":\"" + SendNode + "\",\"content\":\"" + messageContext+ "\",\"type\":10}","utf-8");
			String params = "alias=" + Node+ "&message=" + message + "&channel=3";
			*/
	        ...
	        //connection.setRequestProperty("token", JiveGlobals.getXMLProperty("push.token"));
