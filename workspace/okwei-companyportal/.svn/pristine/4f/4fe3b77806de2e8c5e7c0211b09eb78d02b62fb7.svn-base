...
function ShareToQzone(title, pageurl, source) {
    window.open('http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url='+encodeURIComponent(pageurl)+'&title='+encodeURIComponent(title)+'&pics=&summary='+encodeURIComponent(source),'_blank');
}
//分享到飞信空间
