...
import com.okwei.supplyportal.bean.enums.MsgType;
import com.okwei.supplyportal.bean.enums.ProductBType;
import com.okwei.supplyportal.bean.enums.ProductTagType;
...
public class EditProductInfoService extends BaseService implements IEditProductInfoService {
	...
	public BaseResultVO editProductInfo(EditProductVO product) {
		...
		pModel.setTag(tag);
		pModel.setSupperType(supply.getType());	
		...
		//luncene 正式的供应商才能被搜索
		if(IsAnIdentity(supply.getType())){
