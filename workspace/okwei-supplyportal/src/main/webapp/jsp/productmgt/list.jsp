...
<body class="bg_f3">
	<form id="searcherForm" name="searcherForm"
		action="<%=basePath%>distributor/list" onsubmit="return true;">
		<div class="fl conter_right">
			...
			<div class="gygl_xxk mt_20">
				...
				<!-- 仓库中 -->
				<table style="display: none;" id="mzh_click_1"
					class="gygl_xxk_table">
					<tbody>
						<tr class="ndfxs_1-2_color ndfxs_1-2_border lh_40 fw_b td_no">
							<td>图片</td>
							<td>标题</td>
				...
				<!-- 草稿箱 -->
				<table style="display: none;" id="mzh_click_4"
					class="gygl_xxk_table">
					<tbody>
						<tr class="ndfxs_1-2_color ndfxs_1-2_border lh_40 fw_b td_no">
							<td>图片</td>
