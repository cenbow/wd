...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/statics/js/order/orderdetails.js"></script>
<script type="text/javascript"
				...
				<c:choose>
					...
					<c:when test="${details.orderState==12}">
						...
						<c:if test="${details.tailPayType==0 }">
							...
							<div class="ddxq_gg_ddzt_xx_1 mt_20 ml_30">
								1.付款方式：支付预定金额${details.percentage }%/支付预定金额<font
				...
				<div class="ddxq_gg_sldc_1_sh">
					...
					<div class="ddxq_gg_sldc_1_sh_1">
						<span class="ddxq_gg_sldc_1_sh_1_span">订单号：<font>${details.orderNo }</font></span><span
							class="ddxq_gg_sldc_1_sh_1_span ml_10"> 支付方式：<font>${details.payWay }</font></span>
						<span class="ddxq_gg_sldc_1_sh_1_span"> 参与促销：<font>${details.preferential }</font></span>
					</div>
