...
<body>
	<div class="weiz_iam f12 fm_song">
		当前位置：<a href="<%=sellerdomain %>">供应管理</a>&gt;
		<a href="<%=sellerdomain %>/order/buylist">订单列表</a>&gt;<span>售后详请</span>
	</div>
	<div class="ddxq_gg">
		<!-- 流程 -->
		...
		<div class="ddxq_gg_ddzt">
			<c:choose>
								...
								<div class="ddxq_gg_ddzt_xx_1 f14 ml_30 mt_20">
									<c:choose>
										<c:when test="${details.orderType == 1 }">
											<a href="javascript:void(0);" onclick="agreedwin('${details.backOrder }')" class="wdqb_cz_tx" style="float: none; display: inline-block; color: #333;">同意</a> 或
										...
										<c:otherwise>
											<a href="javascript:void(0);" onclick="agreedwin('${details.backOrder }')" class="wdqb_cz_tx" style="float: none; display: inline-block; color: #333;">同意</a>
				...
				<c:when test="${details.refundType == 5 }">
					<!-- 买家已发货 -->
					<div class="ddxq_gg_ddzt_xx">
						当前订单状态：<b>采购商已发货</b>； <a href="javascript:void(0);" onclick="confirmcargowin('${details.backOrder}')">确认收货</a>
					</div>
