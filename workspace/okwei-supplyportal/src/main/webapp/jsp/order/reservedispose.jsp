...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/statics/js/order/orderdispose.js"></script>
...
<body>
	<form action="reservedConfirm?v=1" method="post" accept-charset="utf-8"
		...
		<div class="weiz_iam f12 fm_song">
			当前位置： <a href="<%=sellerdomain %>">供应管理</a>&gt; <a
				href="<%=sellerdomain %>/order/reservelist">预定列表</a>&gt; <a
				href="<%=sellerdomain %>/order/delivery?orderNo=${details.orderNo }">
				<c:choose>
		...
		<div class="ddxq_gg">
				...
				<div class="ddxq_gg_sldc_1 margin_20">
					...
					<div class="ddxq_gg_sldc_1_sh">
						...
						<div class="ddxq_gg_sldc_1_sh_1">
							...
							<span class="ddxq_gg_sldc_1_sh_1_span"> 联系电话 ：<font>${details.reciverPhoneNumber }</font></span>
						</div>
						<div class="ddxq_gg_sldc_1_sh_1">
			...
			<div class="blank1"></div>
			<input class="mzh_4_20_qrdd" type="submit" value="确定订单" /> <a
				href="javascript:void(0);" class="mzh_4_20_jjdd" onclick="refused()">拒绝订单</a>
			<div class="blank1"></div>
		</div>
	</form>
</body>
