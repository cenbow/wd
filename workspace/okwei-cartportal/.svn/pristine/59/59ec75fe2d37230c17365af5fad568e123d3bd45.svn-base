  ...
  <div class="wdwrap">
    <div class="bottom-text">
      ...
      <dl style="margin-left:82px;">
        ...
        <dd class="bg_blue"><a href="<%=joindomain %>/supplier/apply?w=${}" target="_blank">供应商进驻</a></dd>
      </dl>
      <dl style="margin-left:82px;">
        <dt>微店网客服</dt>
        <dd>
      ...
      <dl style=" margin-left:82px; float:left;display:inline;">
        <dt>手机微店网</dt>
        <dd><img src="http://base.okwei.com/images/wd-wx1.png" width="80" height="80" alt="手机微店网" /></dd>
      </dl>
      <dl style=" margin-left:60px; float:left;display:inline;">
        <dt>微店网服务号</dt>
        <dd><img src="http://base.okwei.com/images/wd-wx.png" width="80" height="80" alt="微店网服务号" /></dd>
      </dl>
      <dl style="float:right;display:inline;">
        <dt>微店网APP下载</dt>
        <dd><img src="http://base2.okimgs.com/images/wd-wx2.png" width="80" height="80" alt="微店网服务号" /></dd>
      </dl>
    </div>
  </div>
  <div class="clear"></div>
...
<div class="foot fl">
  <div class="wdwrap">
    ...
    <p class="foot-pic"> <a target="_blank" href="#" title="营业执照"><img alt="营业执照" src="http://base.okwei.com/images/foot1.png"></a> <a target="_blank" href="#" title="税务登记"><img alt="税务登记" src="http://base.okwei.com/images/foot2.png"></a> <a target="_blank" href="#" title="工商网监"><img alt="工商网监" src="http://base.okwei.com/images/foot3.png"></a> <a target="_blank" href="#" title="众信网络身份现场认证"><img alt="众信网络身份现场认证" src="http://base.okwei.com/images/foot4.png"></a> <a target="_blank" href="#" title="可信网站认证"><img alt="可信网站认证" src="http://base.okwei.com/images/foot5.png"></a> <a target="_blank" href="#" title="电信增值服务许可证"><img alt="电信增值服务许可证" src="http://base.okwei.com/images/foot6.png"></a> <a target="_blank" href="#" title="财付通特约商户"><img alt="财付通特约商户" src="http://base.okimgs.com/images/foot7-1.png"></a> <a target="_blank" href="#" title="银联特约商户"><img alt="银联特约商户" src="http://base2.okimgs.com/images/foot8-1.png"></a> </p>
  </div>
</div>
</footer>
