...
String walletdomain = ResourceBundle.getBundle("domain").getString(
		"walletdomain");
String setdomain = ResourceBundle.getBundle("domain").getString(
		"setdomain");
String okweidomain = ResourceBundle.getBundle("domain").getString(
		"okweidomain");
String verifydomain = ResourceBundle.getBundle("domain").getString(
		"verifydomain");
%>
		...
		<div class="head_right fr ft_sixc">
			<div class="fr po-re" name="mzh_sjwd">
				...
				<div class="div-posabues">
					<a href="http://app.okwei.com/" class="eweim-imgs fl"> <img
						src="/statics/images/xh-addtop010.png">
					</a>
				</div>
			</div>
			<a href="javascript:ibsLogOut();" class="mzh_a ba_no ml_10 fr">退出</a>
			<span class="ft_c6 fr lh_36">欢迎您，${userinfo.weiName }</span>
		</div>
	</div>
</div>
<div class="head_two">
	<div class="mar_au">
		<div class="head_logo fl">
			<a href="http://www.okwei.com"><img
				src="/statics/images/xh_logo.gif"></a>
		</div>
		<div class="head_weid fl">
			<a target="_blank" href="http://www.okwei.com/aboutus.html"><img
				src="/statics/images/xh_gaiban_cctv.png"></a>
		...
		<div class="fl navs">
			<ul class="fl">
				...
				<li name="mainMenu" class="li_img"><a href="<%=walletdomain%>/walletMgt/index">钱包</a></li>
