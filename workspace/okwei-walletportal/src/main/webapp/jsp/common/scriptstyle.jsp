...
<title>个人后台首页</title>
<!-- 前端css库 start-->
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/statics/css/glbdy.css?_=${VERSION}" />
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/statics/css/index.css?_=${VERSION}" />
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/statics/css/jumei_usercenter.min.css?_=${VERSION}" />
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/statics/css/m_shouji.css?_=${VERSION}" />
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/statics/css/mzh_dd_ddxq.css?_=${VERSION}" />
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/statics/css/mzh_dd.css?_=${VERSION}" />
...
<script type="text/javascript" src="<%=request.getContextPath() %>/statics/js/lib/jquery-ui-1.11.4.custom/jquery-ui.js?_=${VERSION}"></script>
<script type="text/javascript" src="<%=request.getContextPath() %>/statics/js/lib/jquery-validation-1.13.1/dist/jquery.validate.min.js?_=${VERSION}"></script>
<link rel="stylesheet" type="text/css" href="/statics/js/lib/jquery-ui-1.11.4.custom/jquery-ui.css?_=${VERSION}" />
<link rel="stylesheet" type="text/css" href="/statics/js/lib/jquery-validation-1.13.1/dist/localization/messages_zh.min.js?_=${VERSION}" />
