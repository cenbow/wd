package com.okwei.walletportal.web.filter;
...
//            domainUrl = domainUrl + "?" + queryString;
//        }
//        /**
//         * 下面这句话 add by 阿甘 过滤https
//         */
//        if(domainUrl.indexOf(".okwei.com")>=0){
...
//                // 没有找到用户信息，没有登陆，跳转登录页
//                httpResponse.sendRedirect(domainUrl);
//                //httpResponse.sendRedirect("http://port.okwei.com/login.aspx?a=1&back=" + domainUrl + "&c=" + cookie_tiket);
//                return;
//            }
//        }
//        else
