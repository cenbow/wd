 ...
 */
@Entity
@Table(name = "P_ProductClassTemp")
public class PProductClassTemp extends BaseEntity {
	...
	/** default constructor */
	public PProductClassTemp() {
	}

	/** full constructor */
	public PProductClassTemp(Integer parentId, String className, Short step) {
