...
/**
 * AppPscoreLog entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "APP_PScoreLog")
public class AppPscoreLog implements java.io.Serializable {
	...
	/** full constructor */
	public AppPscoreLog(Long productId, Short scoreType, Integer mid,
