...
/**
 * UAgentSupplyer entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "U_AgentSupplyer")
public class UAgentSupplyer implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8209984188939488923L;
	// Fields
	...
	/** default constructor */
	public UAgentSupplyer() {
	}

	/** full constructor */
	public UAgentSupplyer(String supplyName, Long verifier, String saleType,
			String logo, String details, Long bond, Integer provice,
			Integer city, Integer area, String address, String linkMan,
			String mobilePhone, String telephone, String serviceQq,
			Date createTime, Long admission, String brandFeature,
			String idcard, String idcardImg, Integer industry,
			String licenseImg, Integer payType, Integer warningNum,
			Date joinTime, Long followVerifier, Long advisor, Short state,
			String appDetails, String appBrandFeature) {
	...
	public void setWeiId(Long channelId) {
		this.weiId = channelId;
	}
