...
public class BAmountSettings {
     ...
     * 微店主 70%的佣金 0.7m;
     */
    public static double yunSeller = ParseHelper.toDouble(AppSettingUtil.getSingleValue("YunSeller")) ;// Double.parseDouble(AppSettingUtil.getSingleValue("YunSeller"));
    /**
     * 介绍人 30%的佣金 0.3
     */
     ...
     * 平台抽点 订单金额的10%
     */
    public static double platformPercent= 0.1; //Double.parseDouble(AppSettingUtil.getSingleValue("platformPercent"));
}
