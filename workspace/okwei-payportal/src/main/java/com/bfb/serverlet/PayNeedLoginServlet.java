...
public class PayNeedLoginServlet extends HttpServlet {
 
	
	private ServletConfig scon = null;
	
	public PayNeedLoginServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//��ӡ��־
		Logger logger =new  com.bfb.util.BfbSdkComm().printLog("PayNeedLoginServlet");
		/**
		 *2�� ��ȡ web.xml�ĳ���ֵ
	     */
	    //��Ʒ�����
	    ...
	    //�ύ��ַ
	    String BFB_PAY_DIRECT_LOGIN_URL=scon.getServletContext().getInitParameter("BFB_PAY_DIRECT_LOGIN_URL");
       ...
       //֧����ʽ
		 ...
		 *  array1��ַ��ƴ�Ӵ�
		 */
		String getURL=new BfbSdkComm().create_baifubao_pay_order_url(array,array1,BFB_PAY_DIRECT_LOGIN_URL);
		//��ӡ�ύ��
		//out.println("getURL��"+getURL+"<br/>"); 
		//�ύ��������ת��ҳ��ٸ�������̨
