...
function Backdrop(opacity) {
    ...
    this.show = function() {
        if (!modal || !modal.length) {
            if (opacity == undefined) {
                modal = $("<div class='modal-backdrop fade in' id='" + id + " style='z-index:199999;opacity:0.4;'></div>");
                //part.append(modal);
            } else {
                modal = $("<div class='modal-backdrop fade' id='" + id + " style='z-index:199999;opacity:" + opacity + ";'></div>");
            }
            part.append(modal);
        }
    };
