...
@Controller
@RequestMapping(value = "/selleruserinfo")
public class SellerUserInfoController extends SSOController
{

    @Autowired
    private ISellerUserInfoService userInfoService;
