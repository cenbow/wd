...
public class DeputyListVO implements Serializable {
	/**
	 * 
	 */
	...
	public String getUpweiname() {
		return upweiname;
	}
	public void setUpweiname(String upweiname) {
		this.upweiname = upweiname;
	}
