...
import com.okwei.myportal.dao.IAdressDAO;
import com.okwei.myportal.service.IAdressService;
import com.okwei.service.IRegionService;
import com.okwei.service.impl.BaseService;

@Service
public class AdressService extends BaseService implements IAdressService {
	...
	List<UCustomerAddr> list = adressDAO.getAddressList(weiid);
	...
	if (model.getCaddrId() != null && model.getCaddrId().intValue() > 0) {
	    // 修改
	    UCustomerAddr entity = adressDAO.getUCustomerAddr(model.getCaddrId());
	    if (entity != null) {
		...
		return adressDAO.updateCustomerAddr(entity);
	    }
	    return 0;
	} else {
