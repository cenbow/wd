...
public class SMSClient
{
    ...
    private String sn = "SDK-SKY-010-02291";// 序列号
    private String password = "593887";
    ...
    public SMSClient(String sn,String password) throws UnsupportedEncodingException
    {
        this.sn = sn;
    ...
    /*
     * 方法名称：mdgxsend 功 能：发送个性短信 参 数：mobile,content,ext,stime,rrid,msgfmt(手机号，内容，扩展码，定时时间，唯一标识，内容编码)
     * 返 回 值：唯一标识，如果不填写rrid将返回系统生成的
     */
    public String mdgxsend(String mobile,String content,String ext,String stime,String rrid,String msgfmt)
    {
        String result = "";
    ...
    /*
     * 方法名称：mdsmssend 功 能：发送短信 参 数：mobile,content,ext,stime,rrid,msgfmt(手机号，内容，扩展码，定时时间，唯一标识，内容编码) 返
     * 回 值：唯一标识，如果不填写rrid将返回系统生成的
     */
