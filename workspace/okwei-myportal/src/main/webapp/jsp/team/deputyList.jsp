...
<body>
<form id="searcherForm" name="searcherForm" action="/teamMgt/deputyList" onsubmit="return true;"> 
  <div class="fr conter_right">
      <div class="zhuag_suv bor_si fl bg_white">
          <div class="gygl_xxk_t f16 ndfxs_1-2_border">
              <div class="gygl_xxk_yes" style="color:#333;">城主候选人管理<span style="width: 60px;"></span></div>
          </div>
        <div class="xh-shurk">
          <ul>
            <li><span>微店号：</span>
