...
<body>
	<div class="weiz_iam f12 fm_song">
		当前位置：<a href="/maininfo/maininfo">微店中心</a>&gt;<a href="buylist">已销售的产品</a>&gt;
		<span>发货</span>
	</div>
	<div class="ddxq_gg">
		<!-- 下单成功 -->
		<div class="ddxq_gg_ddzt" style="padding: 0px;">
			<div class="ddxq_gg_ddzt_left" id="update"
				style="${showorhidden?'':'display: none;'}">
				...
				<dl>
					<dd class="ddxq_gg_ddzt_left_dd">
						<a href="javascript:void(0);" onclick="up()"
							class="jbzl_dl_qrdz f12 ml_10 mr_5"
							style="width: 100px; margin: 10px 0 0 30px; color: #fff;">修改</a>
					</dd>
			...
			<div class="ddxq_gg_ddzt_left"
				...
				<dl class="ddxq_gg_ddzt_left_dl">
					...
					<dt class="ddxq_gg_ddzt_left_dt">
						<input type="text" class="ddxq_gg_ddzt_left_dt_text" value=""
							id="danhao" />
					</dt>
				</dl>
				...
				<dt class="ddxq_gg_ddzt_left_dt">
					<a href="javascript:void(0);"
						onclick="delivery('${details.orderNo}')"
						class="jbzl_dl_qrdz f12 ml_10 mr_5"
						style="width: 100px; margin: 20px 0 0 0px; color: #fff;">提交</a>
				</dt>
			</div>
			...
			<div class="ddxq_gg_ddzt_right">
				...
				<c:if test="${!showorhidden }">
					<div class="ddxq_gg_ddzt_xx_1 f14 ml_30 mt_20"
						style="margin-left: 150px;">~~~未查询到物流详情~~~</div>
				</c:if>
								...
								<tr class="fl">
									<td rowspan="7"
										...
										<div class="fl count_price f12 tr"
											...
											实付款：<span class="f24 ft_red">￥${details.totalPrice }</span>
										</div>
									</td>
								</tr>
							</tbody>
