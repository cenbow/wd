...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/statics/js/seller/editprice.js"></script>
</head>
<body>
			...
			<div class="updprc fl">
				...
				<div class="fl price_title">
					<ul>
						...
						<li class="w189 tc">改价范围</li>
						<li class="w149 tc">改价后单价<img onmouseover="tips(this)"
							name="负数代表优惠折扣"
												...
												<div class=" xiugaiprc fl">
													<ul>
														...
														<li><input type="text" class="btn_h30 w82 youhui"
															value="${pro.price}" maxlength="12" /> 元</li>
													</ul>
													<input type="hidden" value="${pro.productOrderid }" name="productorderid" />
													<input type="hidden" value="${pro.count }" name="productsCount" />
													<input type="hidden" name="lowprice" value="${usertype==1?pro.dukePrice:(usertype==2?pro.deputyPrice:(usertype==3?pro.agentPrice:(usertype==4?pro.supplyPrice:pro.price))) }" name="" />
												</div>
											</c:forEach>
										</div>
									</td>
									<td class="w189" rowspan="2">
										<div class="fl yfei_price">
											<ul>
												...
												<li><input id="kuaidi" type="text"  disabled="disabled"
				...
				<div class="count_money fl">
					<ul>
						...
						<li class="f14 fm_song ft_c3">买家实付： <span class="fm_var f16">
								...
								<span id="freight">${ details.postPrice }</span>  = <span id="totalprice" class="ft_red">${details.totalPrice }</span>
						</span>元
						</li>
