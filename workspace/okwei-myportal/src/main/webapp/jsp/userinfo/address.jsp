	...
	<div class="fl conter_right bg_white bor_si">
		...
		<div class="gygl_xxk_t f16 ndfxs_1-2_border">
			<div style="color: #000;" name="mzh_xxk" class="gygl_xxk_yes">
				收货地址<span style="width: 64px;"></span>
			</div>
		</div>
		<div class="jbzl">
			<div class="jbzl_shdz  p30">
				<c:forEach var="addr" items="${list}" varStatus="index">
					<div class='${addr.isDefault==1?"jbzl_shdz_yes":"jbzl_shdz_no" }' name="divaddress" caddrId="${addr.caddrId }">
